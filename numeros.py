...
#
# Email Impacta: luiz.anduze@aluno.faculdadeimpacta.com.br
...
def conta_primos(s):
    ...
    dicionario = {numeros : primos.count(numeros) for numeros in primos}
...
def lista_armstrong(n):
    ...
    for i in range (0, n):
        if eh_armstrong(i):
            listaArmstrong.append(i)
    
    return listaArmstrong
...
def lista_perfeitos(n):
    ...
    for i in range(2, n):
        if eh_perfeito(i):
            listaPerfeitos.append(i)
    
    return listaPerfeitos
